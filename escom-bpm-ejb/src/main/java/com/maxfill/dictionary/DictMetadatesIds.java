...
public final class DictMetadatesIds {

    private DictMetadatesIds() {
    }
    
    public static final Integer OBJ_DOCS = 1;
    public static final Integer OBJ_FOLDERS = 2;
    public static final Integer OBJ_USERS = 3;
    public static final Integer OBJ_PARTNERS = 4;
    ...
    public static final Integer OBJ_PROCESS = 20;
    public static final Integer OBJ_TASK = 22;
    public static final Integer OBJ_RESULT = 23;
    public static final Integer OBJ_PROC_TEMPL = 24;
    public static final Integer OBJ_ASSISTANT = 25;
    public static final Integer OBJ_REMARK = 26;
}
