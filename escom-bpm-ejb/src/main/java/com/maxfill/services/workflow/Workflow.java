...
public interface Workflow {
    ...
    void addConnector(ConnectorElem connector, BaseElement from, BaseElement to, Scheme scheme, Set<String> errors);
    ...
    void removeElement(BaseElement element, Scheme scheme, Set <String> errors);
