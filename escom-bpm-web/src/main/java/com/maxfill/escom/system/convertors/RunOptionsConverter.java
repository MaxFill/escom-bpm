...
import com.maxfill.escom.beans.processes.options.RunOptionsBean;
 ...
 * @author maksim
 */
@FacesConverter("runOptionsConverter")
public class RunOptionsConverter implements Converter{
    
    @Override
    public Object getAsObject(FacesContext context, UIComponent component, String value) {
        if(value != null && value.trim().length() > 0) {
            try {
                RunOptionsBean bean = EscomBeanUtils.findBean("runOptionsBean", context);
    ...
    public String getAsString(FacesContext context, UIComponent component, Object object) {
        if(object != null) {
            Integer id = ((RunOptions)object).getId();
